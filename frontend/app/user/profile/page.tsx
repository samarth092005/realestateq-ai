        ...
        <main className="mx-auto max-w-5xl space-y-8 pb-12">
          ...
          <div className="relative overflow-hidden rounded-[32px] border border-white/10 bg-card/60 p-8 backdrop-blur-xl transition duration-300 hover:border-white/20">
            ...
            <div className="flex flex-col gap-6 md:flex-row md:items-center">
              {/* Avatar */}
              <div className="flex h-24 w-24 shrink-0 items-center justify-center rounded-[24px] bg-gradient-to-tr from-blue-500 to-emerald-400 text-3xl font-bold text-black shadow-xl shadow-blue-500/10 overflow-hidden">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <span className="rounded-full bg-blue-500/10 px-3 py-1 text-xs font-semibold text-blue-400 border border-blue-500/15">
                    Platform Investor
                  </span>
                </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-[32px] border border-white/10 bg-card/40 p-8 backdrop-blur-xl flex flex-col justify-between">
              <div>
                <h3 className="text-xl font-bold mb-6">Account Status & Security</h3>
                <div className="space-y-4 text-sm">
                  ...
                  <div className="flex items-center justify-between py-2">
                    ...
                    <span className="font-semibold text-xs rounded-xl bg-background/50 border border-white/5 px-3 py-1.5">
                      🔑 {authProvider}
                    </span>
                  </div>
                </div>
              ...
              <div className="mt-8 rounded-2xl bg-white/[0.02] border border-white/5 p-4 text-xs text-muted-foreground/80 flex items-start gap-3">
          ...
          <div className="rounded-[32px] border border-white/10 bg-card/40 p-8 backdrop-blur-xl">
            <h3 className="text-xl font-bold mb-6">Real Estate Activity Summary</h3>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="rounded-2xl border border-white/5 bg-background/40 p-5">
                ...
                <div className="mt-3 flex items-end justify-between">
                  <h4 className="text-3xl font-bold">{savedCount}</h4>
              ...
              <div className="rounded-2xl border border-white/5 bg-background/40 p-5">
                ...
                <div className="mt-3 flex items-end justify-between">
                  <h4 className="text-3xl font-bold">{computedScore}%</h4>
                  <span className="text-xl">🔥</span>
                </div>
              </div>
            </div>
          ...
          <div className="rounded-[32px] border border-white/10 bg-card/60 p-8 backdrop-blur-xl">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-6">
              <div>
                <h3 className="text-xl font-bold">Property Interests & Filters</h3>
                <p className="text-xs text-muted-foreground mt-1">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <div className="flex flex-col gap-2">
                ...
                <select
                  ...
                  className="rounded-2xl border border-white/10 bg-background/50 p-4 text-sm focus:outline-none focus:border-white/20 cursor-pointer"
                >
